...
import tenco.com.test_18.Enemy;
...
//	private ArrayList<Enemy> enemies = new ArrayList<Enemy>();
	...
	private void initObject() {
		backgroundMap = new JLabel(
				new ImageIcon("C:\\workspaceboot_002\\workspaceboot_002\\tenco_01\\images/backgroundMap.png"));
...
//				System.out.println(e.getKeyCode());
				...
				case KeyEvent.VK_UP:
					...
					if (!player.isUp() && !player.isDown()) { // �삱�씪媛덈븣 怨꾩냽 �삱�씪媛�吏� �븡寃�. �뼥�뼱吏� �썑 �떎�떆 �벐�젅�뱶
																// �깮�꽦�빐�빞�븿.
						player.up();
					}
					break;
